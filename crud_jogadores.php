...
<title>Criar, atualizar e excluir Jogadores</title>
...
<body>
	...
	<div class="container">
      <div class="">
        <h2>Criar, atualizar e excluir Jogadores</h2>
        <div class="col-sm-8">
		<div >
		...
		<table id="employee_grid" class="table table-condensed table-hover table-striped" width="60%" cellspacing="0" data-toggle="bootgrid">
			<thead>
				<tr>
					...
					<th data-column-id="pontuacao">Pontuação</th>
					<!-- <th data-column-id="employee_age">Idade</th> -->
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				...
				<input type="hidden" value="add" name="action" id="action">
                  ...
                  <div class="form-group">
                    <label for="salary" class="control-label">Pontuação:</label>
                    <input type="text" class="form-control" id="salary" name="salary"/>
                  </div>
				  <!-- <div class="form-group">
                    <label for="salary" class="control-label">Idade:</label>
...
<div id="edit_model" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Editar Jogador</h4>
            </div>
            <div class="modal-body">
...
console.log(g_id);
    ...
    }).end().find(".command-delete").on("click", function(e)
    {
		...
		var conf = confirm('Delete ' + $(this).data("row-id") + ' items?');
					alert(conf);
                    if(conf){
                                $.post('response_jogadores.php', { id: $(this).data("row-id"), action:'delete'}
                                    , function(){
...
function ajaxAction(action) {
				...
				$.ajax({
				  ...
				  data: data,
				  dataType: "json",       
				  success: function(response_jogadores)  
				  {
