...
<?php
	...
	function insertEmployee($params) {
		$data = array();;
		$sql = "INSERT INTO `pergunta` (pergunta, resposta_certa, resposta_errada) VALUES('" . $params["name"] . "', '" . $params["salary"] . "','" . $params["age"] . "');  ";
	...
	function updateEmployee($params) {
		$data = array();
		//print_R($_POST);die;
		$sql = "Update `perguntas` set pergunta = '" . $params["edit_name"] . "', employee_salary='" . $params["edit_salary"]."', employee_age='" . $params["edit_age"] . "' WHERE id='".$_POST["edit_id"]."'";
